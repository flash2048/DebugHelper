...
namespace DebugHelper.Tests
{
    ...
    public class DllInjectTests
    {
        ...
        [DataRow(".NETFramework,Version=v4.7.2", false, "The .NET Framework with a version lower than 4.5 is not supported.")]
        [DataRow(".NETFramework,Version=v4.6", false, "The .NET Framework with a version lower than 4.5 is not supported.")]
